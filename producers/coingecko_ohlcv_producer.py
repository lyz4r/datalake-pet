# апи с этого продьюсера резко перестало работать, теперь ohlcv считается в марте для тикеров байбит
# на нем очень жесткие рейтлимиты, а нужно пройтись по 17000 монетам =)
